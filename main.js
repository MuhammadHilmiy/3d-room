...
let projects = [
  {
    image: 'textures/iotweb.jpeg',
    url: 'https://bils.site/',
  },
  {
    image: 'textures/videoplay.jpeg',
    url: 'https://videoplaylisthilmiy.netlify.app/',
  },
  {
    image: 'textures/hacker.jpeg',
    url: 'https://cybermap.netlify.app/',
  },
  {
    image: 'textures/lockscreen.jpeg',
    url: 'https://appmenulock.netlify.app/',
  },
];
let aboutCameraPos = {
  x: 0.12,
...
function loadIntroText() {
  ...
  loader.load('fonts/unione.json', function (font) {
    ...
    const titleGeo = new TextGeometry('Lynex || Hilmiy', {
      font: font,
      size: 0.08,
      height: 0.01,
    });
  ...
  loader.load('fonts/helvatica.json', function (font) {
    ...
    const subTitleGeo = new TextGeometry(
      'Web Designer / GameTester / Content Creator',
      {
        font: font,
        size: 0.018,
        height: 0,
